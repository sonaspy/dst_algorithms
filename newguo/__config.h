...
// Fix undefined behavior in how dsa::list stores it's linked nodes.
...
// dsa::random_device is instead exposed through a NaCl syscall.
...
#define _LIBCPP_BEGIN_NAMESPACE_DSA    \
    namespace dsa                      \
    {                                  \
    inline namespace _LIBCPP_NAMESPACE \
    {
#define _LIBCPP_END_NAMESPACE_DSA \
    }                             \
    }
#define _VDSA dsa::_LIBCPP_NAMESPACE
...
#define static_assert(__b, __m) typedef __static_assert_check < sizeof(__static_assert_test <(__b)>) > \
...
#ifndef _LIBCPP_DSA_VER
#if __cplusplus <= 201103L
#define _LIBCPP_DSA_VER 11
#elif __cplusplus <= 201402L
#define _LIBCPP_DSA_VER 14
#else
#define _LIBCPP_DSA_VER 16 // current year, or date of c++17 ratification
#endif
#endif // _LIBCPP_DSA_VER

#if _LIBCPP_DSA_VER > 11
...
#if _LIBCPP_DSA_VER > 11 && !defined(_LIBCPP_HAS_NO_CXX14_CONSTEXPR)
#define _LIBCPP_CONSTEXPR_AFTER_CXX11 constexpr
#else
#define _LIBCPP_CONSTEXPR_AFTER_CXX11
#endif

#if _LIBCPP_DSA_VER > 14 && !defined(_LIBCPP_HAS_NO_CXX14_CONSTEXPR)
...
#define _LIBCPP_EXPLICIT_MOVE(x) _VDSA::move(x)
#else
...
#if defined(__GNUC__) && ((__GNUC__ >= 5) || (__GNUC__ == 4 && (__GNUC_MINOR__ >= 3 || __GNUC_PATCHLEVEL__ >= 2))) && !defined(__GXX_RTTI)
#define _LIBCPP_NO_RTTI
...
#ifdef __CloudABI__
#define _LIBCPP_HAS_NO_DSAIN
#define _LIBCPP_HAS_NO_DSAOUT
#endif
...
#if (!defined(_LIBCPP_HAS_C_ATOMIC_IMP) && !defined(_LIBCPP_HAS_GCC_ATOMIC_IMP)) || defined(_LIBCPP_HAS_NO_THREADS)
...
#if (defined(_LIBCPP_ENABLE_THREAD_SAFETY_ANNOTATIONS) && defined(__clang__) && __has_attribute(acquire_capability))
