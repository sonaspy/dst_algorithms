...
// file directly.
// dst_config.h should be included before this file.

#ifndef ___DST_INTERNAL_THREADS_H
#define ___DST_INTERNAL_THREADS_H

// Supported threading models are native , pthreads, uithreads
...
#include <thread.h>
#elif defined(__DST_MACOSTHREADS)
#endif
...
{
#if defined(__DST__THREADS) || defined(__DST_MACOSTHREADS)
...
#elif defined(__DST__THREADS) || defined(__DST_MACOSTHREADS)
