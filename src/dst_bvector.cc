#ifndef ___DST_INTERNAL_BVECTOR_H
#define ___DST_INTERNAL_BVECTOR_H
...
struct _Bit_const_iterator : public _Bit_iterator_base {
    ...
    const_reference operator[](difference_type __i) { return *(*this + __i); }
};
...
// old -style allocators and standard-conforming allocators.
...
class _Bvector_alloc_base {
  public:
    typedef
        typename _Alloc_traits<bool, _Allocator>::allocator_type allocator_type;
...
#if defined(__DST_CLASS_PARTIAL_SPECIALIZATION) && !defined(__DST_NO_BOOL)
#define ___DST_VECBOOL_TEMPLATE
...
#define __BVECTOR_BASE _Bvector_base<__DST_DEFAULT_ALLOCATOR(bool)>
#define __BVECTOR_TMPL_LIST
#endif /* __DST_CLASS_PARTIAL_SPECIALIZATION && !__DST_NO_BOOL */
...
class __BVECTOR : public __BVECTOR_BASE {
  ...
  public:
    ...
    void _M_range_check(size_type __n) const {
        if (__n >= this->size())
            __dst_throw_range_error("vector<bool>");
    }
    ...
    explicit __VECTOR(size_type __n) : __BVECTOR_BASE(allocator_type()) {
        _M_initialize(__n);
...
#ifdef ___DST_VECBOOL_TEMPLATE

// This typedef is non-standard.  It is provided for backward compatibility.
typedef vector<bool, alloc> bit_vector;

#else /* ___DST_VECBOOL_TEMPLATE */

inline void swap(bit_vector &__x, bit_vector &__y) { __x.swap(__y); }
...
#endif /* ___DST_INTERNAL_BVECTOR_H */