...
#ifndef ___CPP_LIMITS
#define ___CPP_LIMITS
...
// The DST standard (section 18.2.1) requires that some of the members of
...
// __DST_STATIC_CONST_INIT_BUG macro is defined, it is impossible to write
...
class _Numeric_limits_base {
  public:
    ...
    static __number max() __DST_NOTHROW { return __number(); }

    __DST_DECLARE_LIMITS_MEMBER(int, digits, 0);
    __DST_DECLARE_LIMITS_MEMBER(int, digits10, 0);

    __DST_DECLARE_LIMITS_MEMBER(bool, is_signed, false);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_integer, false);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_exact, false);

    __DST_DECLARE_LIMITS_MEMBER(int, radix, 0);

    static __number epsilon() __DST_NOTHROW { return __number(); }
    static __number round_error() __DST_NOTHROW { return __number(); }

    __DST_DECLARE_LIMITS_MEMBER(int, min_exponent, 0);
    __DST_DECLARE_LIMITS_MEMBER(int, min_exponent10, 0);
    __DST_DECLARE_LIMITS_MEMBER(int, max_exponent, 0);
    __DST_DECLARE_LIMITS_MEMBER(int, max_exponent10, 0);
    ...
    static __number quiet_NaN() __DST_NOTHROW { return __number(); }
    static __number signaling_NaN() __DST_NOTHROW { return __number(); }
    static __number denorm_min() __DST_NOTHROW { return __number(); }

    __DST_DECLARE_LIMITS_MEMBER(bool, is_iec559, false);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_bounded, false);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_modulo, false);
...
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_specialized);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, digits);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, digits10);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_signed);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_integer);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_exact);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, radix);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, min_exponent);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, max_exponent);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, min_exponent10);
__DST_DEFINE_NUMERIC_BASE_MEMBER(int, max_exponent10);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, has_infinity);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, has_quiet_NaN);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, has_signaling_NaN);
__DST_DEFINE_NUMERIC_BASE_MEMBER(float_denorm_style, has_denorm);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, has_denorm_loss);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_iec559);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_bounded);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, is_modulo);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, traps);
__DST_DEFINE_NUMERIC_BASE_MEMBER(bool, tinyness_before);
__DST_DEFINE_NUMERIC_BASE_MEMBER(float_round_style, round_style);
...
class _Integer_limits : public _Numeric_limits_base<_Int> {
  public:
    ...
    __DST_DECLARE_LIMITS_MEMBER(bool, is_signed, __imin != 0);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_integer, true);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_exact, true);
    __DST_DECLARE_LIMITS_MEMBER(int, radix, 2);

    __DST_DECLARE_LIMITS_MEMBER(bool, is_bounded, true);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_modulo, __ismod);
};
...
__DST_DEFINE_INTEGER_LIMITS_MEMBER(bool, is_specialized);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(int, digits);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(int, digits10);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(bool, is_signed);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(bool, is_integer);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(bool, is_exact);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(int, radix);
__DST_DEFINE_INTEGER_LIMITS_MEMBER(bool, is_bounded);
...
class _Floating_limits : public _Numeric_limits_base<__number> {
  public:
    ...
    __DST_DECLARE_LIMITS_MEMBER(int, digits10, __Digits10);

    __DST_DECLARE_LIMITS_MEMBER(bool, is_signed, true);

    __DST_DECLARE_LIMITS_MEMBER(int, radix, 2);

    __DST_DECLARE_LIMITS_MEMBER(int, min_exponent, __MinExp);
    __DST_DECLARE_LIMITS_MEMBER(int, max_exponent, __MaxExp);
    __DST_DECLARE_LIMITS_MEMBER(int, min_exponent10, __MinExp10);
    __DST_DECLARE_LIMITS_MEMBER(int, max_exponent10, __MaxExp10);
    ...
    __DST_DECLARE_LIMITS_MEMBER(bool, is_iec559, __IsIEC559);
    __DST_DECLARE_LIMITS_MEMBER(bool, is_bounded, true);
    __DST_DECLARE_LIMITS_MEMBER(bool, traps, true);
    __DST_DECLARE_LIMITS_MEMBER(bool, tinyness_before, false);

    __DST_DECLARE_LIMITS_MEMBER(float_round_style, round_style, __RoundStyle);
};
...
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, digits);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, digits10);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, is_signed);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, radix);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, min_exponent);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, max_exponent);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, min_exponent10);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(int, max_exponent10);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, has_infinity);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, has_quiet_NaN);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, has_signaling_NaN);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(float_denorm_style, has_denorm);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, has_denorm_loss);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, is_iec559);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, is_bounded);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, traps);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(bool, tinyness_before);
__DST_DEFINE_FLOAT_LIMITS_MEMBER(float_round_style, round_style);

#undef __DST_DECLARE_NUMERIC_LIMITS_MEMBER
#undef __DST_DEFINE_NUMERIC_BASE_MEMBER
#undef __DST_DEFINE_INTEGER_LIMITS_MEMBER
#undef __DST_DEFINE_FLOAT_LIMITS_MEMBER
...
#if !defined(LONGLONG_MIN) && !defined(LONGLONG_MAX) && !defined(ULONGLONG_MAX)
...
__DST_TEMPLATE_NULL class numeric_limits<float>
  ...
  public:
    ...
    static float epsilon() __DST_NOTHROW { return FLT_EPSILON; }
    static float round_error() __DST_NOTHROW { return 0.5f; } // Units: ulps.
    static float infinity() __DST_NOTHROW;
    static float quiet_NaN() __DST_NOTHROW;
    static float signaling_NaN() __DST_NOTHROW;
};

__DST_TEMPLATE_NULL class numeric_limits<double>
  ...
  public:
    ...
    static double epsilon() __DST_NOTHROW { return DBL_EPSILON; }
    static double round_error() __DST_NOTHROW { return 0.5; } // Units: ulps.
    static double infinity() __DST_NOTHROW;
    static double quiet_NaN() __DST_NOTHROW;
    static double signaling_NaN() __DST_NOTHROW;
};

__DST_TEMPLATE_NULL class numeric_limits<long double>
  ...
  public:
    ...
    static long double epsilon() __DST_NOTHROW { return LDBL_EPSILON; }
    static long double round_error() __DST_NOTHROW { return 4; } // Units: ulps.
    static long double infinity() __DST_NOTHROW;
    static long double quiet_NaN() __DST_NOTHROW;
    static long double signaling_NaN() __DST_NOTHROW;
};
