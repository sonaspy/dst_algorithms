#ifndef ___DST_INTERNAL_HASH_SET_H
#define ___DST_INTERNAL_HASH_SET_H
...
template <class _Value,
          class _HashFcn __DST_DEPENDENT_DEFAULT_TMPL(hash<_Value>),
          class _EqualKey __DST_DEPENDENT_DEFAULT_TMPL(equal_to<_Value>),
...
class hash_set {
    ...
    __DST_CLASS_REQUIRES(_Value, _Assignable);
    __DST_CLASS_UNARY_FUNCTION_CHECK(_HashFcn, size_t, _Value);
    __DST_CLASS_BINARY_FUNCTION_CHECK(_EqualKey, bool, _Value, _Value);
  ...
  public:
    ...
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const hash_set &, const hash_set &);
#endif /* __DST_MEMBER_TEMPLATES */
...
#else  /* __DST_MEMBER_TEMPLATES */
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const hash_multiset &, const hash_multiset &);
#endif /* __DST_MEMBER_TEMPLATES */
...
#endif /* ___DST_INTERNAL_HASH_SET_H */