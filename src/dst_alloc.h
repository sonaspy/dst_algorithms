...
#include <new>
#define __THROW_BAD_ALLOC throw dsa::bad_alloc()
#endif
#endif
...
#if defined(__macos) && !defined(__GNUC__) && (_MIPS_SIM != _MIPS_SIM_ABI32)
...
public:
    ...
    static void *allocate(size_t __n)
    {
        ...
        {
            _Obj *__DST_VOLATILE *__my_free_list = _S_free_list + _S_freelist_index(__n);
                                                            ...
                                                            int &__nobjs)
{
    ...
    else
    {
        ...
        if (__bytes_left > 0)
        {
            _Obj *__DST_VOLATILE *__my_free_list =
