...
#define ___DST_INTERNAL_FUNCTION_H
...
compose2(const _Operation1 &__fn1, const _Operation2 &__fn2,
    ...
    return binary_compose<_Operation1, _Operation2, _Operation3>(__fn1, __fn2,
                                                                 __fn3);
}
...
class pointer_to_binary_function
  ...
  public:
    ...
    explicit pointer_to_binary_function(_Result (*__x)(_Arg1, _Arg2))
        : __ptr_(__x) {}
    _Result operator()(_Arg1 __x, _Arg2 __y) const { return __ptr_(__x, __y); }
};
...
template <class _Result, class _Argument __DST_DEPENDENT_DEFAULT_TMPL(_Result)>
struct constant_unary_fun : public _Constant_unary_fun<_Result, _Argument> {
    constant_unary_fun(const _Result &__v)
        : _Constant_unary_fun<_Result, _Argument>(__v) {}
};

template <class _Result, class _Arg1 __DST_DEPENDENT_DEFAULT_TMPL(_Result),
          class _Arg2 __DST_DEPENDENT_DEFAULT_TMPL(_Arg1)>
...
//  (mem_fun1 and mem_fun1_ref are no longer part of the DST standard,
...
class const_mem_fun1_t : public binary_function<const _Tp *, _Arg, _Ret> {
  public:
    ...
    _Ret operator()(const _Tp *_p, _Arg __x) const { return (_p->*_M_f)(__x); }
...
template <class _Ret, class _Tp, class _Arg>
inline const_mem_fun1_ref_t<_Ret, _Tp, _Arg> mem_fun1_ref(_Ret (_Tp::*__f)(_Arg)
                                                              const) {
    return const_mem_fun1_ref_t<_Ret, _Tp, _Arg>(__f);
}
...
#endif /* ___DST_INTERNAL_FUNCTION_H */
