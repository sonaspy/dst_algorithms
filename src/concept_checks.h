...
#define __DST_REQUIRES(__type_var, __concept) do {} while(0)
#define __DST_CLASS_REQUIRES(__type_var, __concept) \
  static int  __##__type_var##_##__concept
#define __DST_CONVERTIBLE(__type_x, __type_y) do {} while(0)
#define __DST_REQUIRES_SAME_TYPE(__type_x, __type_y) do {} while(0)
#define __DST_CLASS_REQUIRES_SAME_TYPE(__type_x, __type_y) \
  static int  __##__type_x##__type_y##_require_same_type
#define __DST_GENERATOR_CHECK(__func, __ret) do {} while(0)
...
do { \
  void (*__x)( __type_x , __type_y ) = _DST_CONVERT_ERROR< __type_x , \
...
do { \
  void (*__x)( __type_x , __type_y ) = _DST_SAME_TYPE_ERROR< __type_x, \
...
struct _Assignable_concept_specification {
  static void _Assignable_requirement_violation(_Type __a) {
    ...
    _DST_ERROR::__const_parameter_required_for_assignment_operator(__a,__a);
  }
};
...
_Mutable_TrivialIterator_requirement_violation(_TrivialIterator __i) {
  ...
  // Valid Expressions
  _DST_ERROR::__dereference_operator_and_assignment_requirement_violation(__i);
}
};
...
_RandomAccessIterator_requirement_violation(_RandAccIter __i) {
  ...
  // Valid Expressions
  _DST_ERROR::__iterator_addition_assignment_requirement_violation(__i,
                                                                   _MutDist());
  _DST_ERROR::__iterator_addition_requirement_violation(__i,
                                                        _MutDist());
  _DST_ERROR::
  ...
  _DST_ERROR::__element_access_operator_requirement_violation(__i,
                                                              __dummy_ptr,
                                                              _MutDist());
}
};
...
_Mutable_RandomAccessIterator_requirement_violation(_RandAccIter __i)
{
  ...
  // Valid Expressions
  _DST_ERROR::__element_assignment_operator_requirement_violation(__i,
                  __tmp_ptr, _Dist());
}
};
...
_Allocator_requirement_violation(_Alloc __a) {
  ...
  //__DST_REQUIRES_SAME_TYPE(typename _Alloc::__DST_TEMPLATE rebind<_Tp>::other,
  //                         _Alloc);
}
};
