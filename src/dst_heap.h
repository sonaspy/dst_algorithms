#ifndef ___DST_INTERNAL_HEAP_H
#define ___DST_INTERNAL_HEAP_H
...
inline void push_heap(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
    ...
    __DST_REQUIRES(typename iterator_traits<_RandomAccessIterator>::value_type, _LessThanComparable);
...
inline void
__push_heap_aux(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp, _Distance *, _Tp *)
{
...
inline void
__pop_heap(_RandomAccessIterator __first, _RandomAccessIterator __last, _RandomAccessIterator __result, _Tp __value, _Distance *)
{
    *__result = *__first;
...
inline void __pop_heap(_RandomAccessIterator __first, _RandomAccessIterator __last,
                       _RandomAccessIterator __result, _Tp __value, _Compare __comp, _Distance *)
{
    *__result = *__first;
