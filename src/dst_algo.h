...
{
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES_BINARY_OP(_OP_EQUAL, bool, typename iterator_traits<_InputIter>::value_type, _Tp);
...
{
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_UNARY_FUNCTION_CHECK(_Predicate, bool, typename iterator_traits<_InputIter>::value_type);
...
_ForwardIter adjacent_find(_ForwardIter __first, _ForwardIter __last)
{
    ...
    __DST_REQUIRES(typename iterator_traits<_ForwardIter>::value_type, _EqualityComparable);
    if (__first == __last)
        return __last;
...
{
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_BINARY_FUNCTION_CHECK(_BinaryPredicate, bool,
...
{
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES(typename iterator_traits<_InputIter>::value_type, _EqualityComparable);
    __DST_REQUIRES(_Tp, _EqualityComparable);
...
{
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_UNARY_FUNCTION_CHECK(_Predicate, bool,
                     ...
                     _BinaryPred __predicate)
{
    __DST_REQUIRES(_ForwardIter1, _ForwardIterator);
    __DST_REQUIRES(_ForwardIter2, _ForwardIterator);
    __DST_BINARY_FUNCTION_CHECK(_BinaryPred, bool,
                                typename iterator_traits<_ForwardIter1>::value_type,
                                typename iterator_traits<_ForwardIter2>::value_type);
...
void __partial_sort(_RandomAccessIter __first, _RandomAccessIter __middle, _RandomAccessIter __last, _Tp *, _Compare __comp)
{
    ...
    for (_RandomAccessIter __i = __middle; __i < __last; ++__i)
        if (__comp(*__i, *__first))
            __pop_heap(__first, __middle, __i, _Tp(*__i), __comp, __DISTANCE_TYPE(__first));
...
_RandomAccessIter __partial_sort_copy(_InputIter __first, _InputIter __last,
                                      _RandomAccessIter __result_first, _RandomAccessIter __result_last, _Distance *, _Tp *)
{
...
partial_sort_copy(_InputIter __first, _InputIter __last, _RandomAccessIter __result_first, _RandomAccessIter __result_last)
{
    ...
    return __partial_sort_copy(__first, __last, __result_first, __result_last,
                               __DISTANCE_TYPE(__result_first), __VALUE_TYPE(__first));
}
                                      ...
                                      _Compare __comp, _Distance *, _Tp *)
{
    ...
    while (__first != __last)
    {
        if (__comp(*__first, *__result_first))
            __adjust_heap(__result_first, _Distance(0), _Distance(__result_real_last - __result_first), _Tp(*__first), __comp);
        ++__first;
    }
...
inline _RandomAccessIter
partial_sort_copy(_InputIter __first, _InputIter __last, _RandomAccessIter __result_first, _RandomAccessIter __result_last, _Compare __comp)
{
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES(_RandomAccessIter, _Mutable_RandomAccessIterator);
    __DST_CONVERTIBLE(typename iterator_traits<_InputIter>::value_type,
    ...
    __DST_BINARY_FUNCTION_CHECK(_Compare, bool,
                                typename iterator_traits<_RandomAccessIter>::value_type,
                                typename iterator_traits<_RandomAccessIter>::value_type);
    return __partial_sort_copy(__first, __last, __result_first, __result_last, __comp,
                               __DISTANCE_TYPE(__result_first), __VALUE_TYPE(__first));
}
...
void __introsort_loop(_RandomAccessIter __first, _RandomAccessIter __last, _Tp *, _Size __depth_limit)
{
    while (__last - __first > __dst_threshold)
    {
        ...
        _RandomAccessIter __cut =
            __unguarded_partition(__first, __last, _Tp(__median(*__first, *(__first + (__last - __first) / 2), *(__last - 1))));
    ...
    while (__last - __first > __dst_threshold)
    {
        ...
        _RandomAccessIter __cut =
            __unguarded_partition(__first, __last,
                                  _Tp(__median(*__first, *(__first + (__last - __first) / 2), *(__last - 1), __comp)), __comp);
...
void __inplace_stable_sort(_RandomAccessIter __first, _RandomAccessIter __last)
{
    ...
    __merge_without_buffer(__first, __middle, __last, __middle - __first, __last - __middle);
}
...
void __inplace_stable_sort(_RandomAccessIter __first, _RandomAccessIter __last, _Compare __comp)
{
    ...
    __merge_without_buffer(__first, __middle, __last, __middle - __first, __last - __middle, __comp);
}
...
void __merge_sort_loop(_RandomAccessIter1 __first, _RandomAccessIter1 __last, _RandomAccessIter2 __result, _Distance __step_size)
{
    ...
    {
        __result = merge(__first, __first + __step_size, __first + __step_size, __first + __two_step, __result);
        __first += __two_step;
    }
...
void __nth_element(_RandomAccessIter __first, _RandomAccessIter __nth, _RandomAccessIter __last, _Tp *, _Compare __comp)
{
    ...
    {
        _RandomAccessIter __cut =
            __unguarded_partition(__first, __last, _Tp(__median(*__first, *(__first + (__last - __first) / 2), *(__last - 1), __comp)), __comp);
        if (__cut <= __nth)
            __first = __cut;
        else
            __last = __cut;
...
template <class _RandomAccessIter, class _Compare>
inline void nth_element(_RandomAccessIter __first, _RandomAccessIter __nth, _RandomAccessIter __last, _Compare __comp)
{
    __DST_REQUIRES(_RandomAccessIter, _Mutable_RandomAccessIterator);
    __DST_BINARY_FUNCTION_CHECK(_Compare, bool,
                                typename iterator_traits<_RandomAccessIter>::value_type,
...
{
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_REQUIRES_SAME_TYPE(_Tp, typename iterator_traits<_ForwardIter>::value_type);
    __DST_REQUIRES(_Tp, _LessThanComparable);
...
template <class _ForwardIter, class _Tp, class _Compare>
inline _ForwardIter upper_bound(_ForwardIter __first, _ForwardIter __last, const _Tp &__val, _Compare __comp)
{
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_REQUIRES_SAME_TYPE(_Tp, typename iterator_traits<_ForwardIter>::value_type);
    __DST_BINARY_FUNCTION_CHECK(_Compare, bool, _Tp, _Tp);
    return __upper_bound(__first, __last, __val, __comp, __DISTANCE_TYPE(__first));
}
...
__equal_range(_ForwardIter __first, _ForwardIter __last, const _Tp &__val, _Compare __comp, _Distance *)
{
    _Distance __len = 0;
    distance(__first, __last, __len);
    _Distance __half;
...
template <class _InputIter1, class _InputIter2, class _OutputIter>
_OutputIter merge(_InputIter1 __first1, _InputIter1 __last1, _InputIter2 __first2,
                  _InputIter2 __last2, _OutputIter __result)
{
    __DST_REQUIRES(_InputIter1, _InputIterator);
    __DST_REQUIRES(_InputIter2, _InputIterator);
    __DST_REQUIRES(_OutputIter, _OutputIterator);
...
_OutputIter merge(_InputIter1 __first1, _InputIter1 __last1, _InputIter2 __first2,
                  _InputIter2 __last2, _OutputIter __result, _Compare __comp)
{
    __DST_REQUIRES(_InputIter1, _InputIterator);
    __DST_REQUIRES(_InputIter2, _InputIterator);
    __DST_REQUIRES_SAME_TYPE(
...
find_end(_ForwardIter1 __first1, _ForwardIter1 __last1, _ForwardIter2 __first2, _ForwardIter2 __last2, _BinaryPredicate __comp)
{
    ...
    return __find_end(__first1, __last1, __first2, __last2, __ITERATOR_CATEGORY(__first1), __ITERATOR_CATEGORY(__first2), __comp);
}
...
inline bool is_heap(_RandomAccessIter __first, _RandomAccessIter __last, _StrictWeakOrdering __comp)
{
    __DST_REQUIRES(_RandomAccessIter, _RandomAccessIterator);
    __DST_BINARY_FUNCTION_CHECK(_StrictWeakOrdering, bool,
                                typename iterator_traits<_RandomAccessIter>::value_type,
                                typename iterator_traits<_RandomAccessIter>::value_type);
...
{
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_REQUIRES(typename iterator_traits<_ForwardIter>::value_type, _LessThanComparable);
    if (__first == __last)
        return true;
