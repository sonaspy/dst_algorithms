...
class BinaryOperation> OutputIterator transform(InputIterator1 first1,
...
template <class ForwardIterator, class Predicate>
    ForwardIterator
    stable_partition(ForwardIterator first, ForwardIterator last, Predicate
pred);
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
class Compare> OutputIterator merge(InputIterator1 first1, InputIterator1 last1,
          InputIterator2 first2, InputIterator2 last2, OutputIterator result,
Compare comp);
...
template <class InputIterator1, class InputIterator2>
    bool
    includes(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2,
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
class Compare> OutputIterator set_union(InputIterator1 first1, InputIterator1
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
class Compare> OutputIterator set_intersection(InputIterator1 first1,
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
class Compare> OutputIterator set_difference(InputIterator1 first1,
InputIterator1 last1, InputIterator2 first2, InputIterator2 last2,
OutputIterator result, Compare comp);
...
template <class InputIterator1, class InputIterator2, class OutputIterator,
class Compare> OutputIterator set_symmetric_difference(InputIterator1 first1,
InputIterator1 last1, InputIterator2 first2, InputIterator2 last2,
OutputIterator result, Compare comp);
...
template <class RandomAccessIterator, class Compare>
    void
    pop_heap(RandomAccessIterator first, RandomAccessIterator last, Compare
comp);
...
template<class ForwardIterator>
    pair<ForwardIterator, ForwardIterator>
    minmax_element(ForwardIterator first, ForwardIterator last);   // constexpr
in C++14
...
// __DST_REQUIRES, __DST_CONVERTIBLE, etc.
...
inline const _Tp &__median(const _Tp &__a, const _Tp &__b, const _Tp &__c,
                           _Compare __comp) {
    __DST_BINARY_FUNCTION_CHECK(_Compare, bool, _Tp, _Tp);
    if (__comp(__a, __b))
        if (__comp(__b, __c))
            return __b;
...
inline _InputIter find(_InputIter __first, _InputIter __last,
                       const _Tp &__val) {
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES_BINARY_OP(
        _OP_EQUAL, bool, typename iterator_traits<_InputIter>::value_type, _Tp);
...
_ForwardIter1 search(_ForwardIter1 __first1, _ForwardIter1 __last1,
    ...
    __DST_REQUIRES(_ForwardIter1, _ForwardIterator);
    __DST_REQUIRES(_ForwardIter2, _ForwardIterator);
    __DST_REQUIRES_BINARY_OP(
        _OP_EQUAL, bool, typename iterator_traits<_ForwardIter1>::value_type,
...
_ForwardIter search_n(_ForwardIter __first, _ForwardIter __last,
    ...
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_BINARY_FUNCTION_CHECK(
        _BinaryPred, bool, typename iterator_traits<_ForwardIter>::value_type,
        _Tp);
    if (__count <= 0)
        return __first;
    else {
...
void replace(_ForwardIter __first, _ForwardIter __last, const _Tp &__old_value,
             const _Tp &__new_value) {
    __DST_REQUIRES(_ForwardIter, _Mutable_ForwardIterator);
    __DST_REQUIRES_BINARY_OP(_OP_EQUAL, bool,
                             typename iterator_traits<_ForwardIter>::value_type,
                             _Tp);
...
void replace_if(_ForwardIter __first, _ForwardIter __last, _Predicate __pred,
                const _Tp &__new_value) {
    __DST_REQUIRES(_ForwardIter, _Mutable_ForwardIterator);
    __DST_CONVERTIBLE(_Tp, typename iterator_traits<_ForwardIter>::value_type);
    __DST_UNARY_FUNCTION_CHECK(
...
_OutputIter replace_copy(_InputIter __first, _InputIter __last,
                         _OutputIter __result, const _Tp &__old_value,
                         const _Tp &__new_value) {
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES(_OutputIter, _OutputIterator);
    __DST_REQUIRES_BINARY_OP(
...
inline _OutputIter __unique_copy(_InputIter __first, _InputIter __last,
                                 _OutputIter __result, output_iterator_tag) {
...
template <class _InputIter, class _OutputIter, class _BinaryPredicate,
          class _Tp>
_OutputIter __unique_copy(_InputIter __first, _InputIter __last,
                          _OutputIter __result, _BinaryPredicate __binary_pred,
                          _Tp *) {
    __DST_BINARY_FUNCTION_CHECK(_BinaryPredicate, bool, _Tp, _Tp);
    _Tp __value = *__first;
    *__result = __value;
    while (++__first != __last)
...
_OutputIter reverse_copy(_BidirectionalIter __first, _BidirectionalIter __last,
                         _OutputIter __result) {
...
_RandomAccessIter __rotate(_RandomAccessIter __first,
                           _RandomAccessIter __middle, _RandomAccessIter __last,
                           _Distance *, _Tp *) {
...
inline _ForwardIter rotate(_ForwardIter __first, _ForwardIter __middle,
                           _ForwardIter __last) {
    __DST_REQUIRES(_ForwardIter, _Mutable_ForwardIterator);
    return __rotate(__first, __middle, __last, __DISTANCE_TYPE(__first),
...
template <class _InputIter, class _RandomAccessIter>
inline _RandomAccessIter random_sample(_InputIter __first, _InputIter __last,
...
inline _RandomAccessIter random_sample(_InputIter __first, _InputIter __last,
    ...
    __DST_REQUIRES(_InputIter, _InputIterator);
    __DST_REQUIRES(_RandomAccessIter, _Mutable_RandomAccessIterator);
    return __random_sample(__first, __last, __out_first, __rand,
                           __out_last - __out_first);
}
...
_BidirectionalIter __partition(_BidirectionalIter __first,
                               _BidirectionalIter __last, _Predicate __pred,
                               bidirectional_iterator_tag) {
    while (true) {
        while (true)
            if (__first == __last)
...
template <class _ForwardIter, class _Predicate>
inline _ForwardIter partition(_ForwardIter __first, _ForwardIter __last,
                              _Predicate __pred) {
    __DST_REQUIRES(_ForwardIter, _Mutable_ForwardIterator);
    __DST_UNARY_FUNCTION_CHECK(
        _Predicate, bool, typename iterator_traits<_ForwardIter>::value_type);
...
_ForwardIter __inplace_stable_partition(_ForwardIter __first,
    ...
    return rotate(
        __inplace_stable_partition(__first, __middle, __pred, __len / 2),
        __middle,
...
_ForwardIter __stable_partition_adaptive(_ForwardIter __first,
                                         _ForwardIter __last, _Predicate __pred,
                                         _Distance __len, _Pointer __buffer,
...
template <class _ForwardIter, class _Predicate>
inline _ForwardIter stable_partition(_ForwardIter __first, _ForwardIter __last,
                                     _Predicate __pred) {
    __DST_REQUIRES(_ForwardIter, _Mutable_ForwardIterator);
    __DST_UNARY_FUNCTION_CHECK(
        _Predicate, bool, typename iterator_traits<_ForwardIter>::value_type);
...
template <class _RandomAccessIter, class _Tp>
inline void __linear_insert(_RandomAccessIter __first, _RandomAccessIter __last,
                            _Tp *) {
    _Tp __val = *__last;
    if (__val < *__first) {
...
void __final_insertion_sort(_RandomAccessIter __first,
    ...
    if (__last - __first > __dst_threshold) {
        __insertion_sort(__first, __first + __dst_threshold);
        __unguarded_insertion_sort(__first + __dst_threshold, __last);
    } else
...
void __final_insertion_sort(_RandomAccessIter __first, _RandomAccessIter __last,
                            _Compare __comp) {
    if (__last - __first > __dst_threshold) {
        __insertion_sort(__first, __first + __dst_threshold, __comp);
        __unguarded_insertion_sort(__first + __dst_threshold, __last, __comp);
    } else
...
template <class _RandomAccessIter>
inline void partial_sort(_RandomAccessIter __first, _RandomAccessIter __middle,
                         _RandomAccessIter __last) {
    __DST_REQUIRES(_RandomAccessIter, _Mutable_RandomAccessIterator);
...
inline void partial_sort(_RandomAccessIter __first, _RandomAccessIter __middle,
    ...
    __DST_REQUIRES(_RandomAccessIter, _Mutable_RandomAccessIterator);
    __DST_BINARY_FUNCTION_CHECK(
        _Compare, bool, typename iterator_traits<_RandomAccessIter>::value_type,
        typename iterator_traits<_RandomAccessIter>::value_type);
    __partial_sort(__first, __middle, __last, __VALUE_TYPE(__first), __comp);
}

template <class _InputIter, class _RandomAccessIter, class _Distance, class _Tp>
_RandomAccessIter __partial_sort_copy(_InputIter __first, _InputIter __last,
...
partial_sort_copy(_InputIter __first, _InputIter __last,
    ...
    __DST_BINARY_FUNCTION_CHECK(
        ...
        typename iterator_traits<_RandomAccessIter>::value_type);
    return __partial_sort_copy(__first, __last, __result_first, __result_last,
                               __comp, __DISTANCE_TYPE(__result_first),
                               __VALUE_TYPE(__first));
}
...
void __introsort_loop(_RandomAccessIter __first, _RandomAccessIter __last,
    ...
    while (__last - __first > __dst_threshold) {
        if (__depth_limit == 0) {
        ...
        _RandomAccessIter __cut = __unguarded_partition(
            __first, __last,
            _Tp(__median(*__first, *(__first + (__last - __first) / 2),
                         *(__last - 1))));
...
void __merge_sort_loop(_RandomAccessIter1 __first, _RandomAccessIter1 __last,
                       _RandomAccessIter2 __result, _Distance __step_size) {
    _Distance __two_step = 2 * __step_size;

    while (__last - __first >= __two_step) {
        __result = merge(__first, __first + __step_size, __first + __step_size,
...
void __merge_sort_loop(_RandomAccessIter1 __first, _RandomAccessIter1 __last,
    ...
    while (__last - __first >= __two_step) {
        __result = merge(__first, __first + __step_size, __first + __step_size,
                         __first + __two_step, __result, __comp);
        __first += __two_step;
    }
    __step_size = min(_Distance(__last - __first), __step_size);
...
void __chunk_insertion_sort(_RandomAccessIter __first, _RandomAccessIter __last,
...
void __merge_sort_with_buffer(_RandomAccessIter __first,
    ...
    _Distance __step_size = __dst_chunk_size;
...
template <class _RandomAccessIter, class _Pointer, class _Distance>
void __stable_sort_adaptive(_RandomAccessIter __first, _RandomAccessIter __last,
...
_OutputIter merge(_InputIter1 __first1, _InputIter1 __last1,
    ...
    __DST_REQUIRES(_InputIter2, _InputIterator);
    __DST_REQUIRES(_OutputIter, _OutputIterator);
    __DST_REQUIRES_SAME_TYPE(typename iterator_traits<_InputIter1>::value_type,
...
_OutputIter merge(_InputIter1 __first1, _InputIter1 __last1,
    ...
    __DST_REQUIRES(_OutputIter, _OutputIterator);
    __DST_BINARY_FUNCTION_CHECK(
        _Compare, bool, typename iterator_traits<_InputIter1>::value_type,
...
void __merge_without_buffer(_BidirectionalIter __first,
    ...
    __merge_without_buffer(__first, __first_cut, __new_middle, __len11,
                           __len22);
...
void __merge_adaptive(_BidirectionalIter __first, _BidirectionalIter __middle,
                      _BidirectionalIter __last, _Distance __len1,
                      _Distance __len2, _Pointer __buffer,
                      _Distance __buffer_size) {
    if (__len1 <= __len2 && __len1 <= __buffer_size) {
        ...
        _BidirectionalIter __new_middle = __rotate_adaptive(
            __first_cut, __middle, __second_cut, __len1 - __len11, __len22,
            __buffer, __buffer_size);
        __merge_adaptive(__first, __first_cut, __new_middle, __len11, __len22,
                         __buffer, __buffer_size);
...
inline void __inplace_merge_aux(_BidirectionalIter __first,
    ...
    if (__buf.begin() == 0)
        ...
        __merge_adaptive(__first, __middle, __last, __len1, __len2,
                         __buf.begin(), _Distance(__buf.size()), __comp);
}
...
bool includes(_InputIter1 __first1, _InputIter1 __last1, _InputIter2 __first2,
              _InputIter2 __last2) {
    __DST_REQUIRES(_InputIter1, _InputIterator);
    __DST_REQUIRES(_InputIter2, _InputIterator);
    __DST_REQUIRES_SAME_TYPE(typename iterator_traits<_InputIter1>::value_type,
...
bool includes(_InputIter1 __first1, _InputIter1 __last1, _InputIter2 __first2,
              _InputIter2 __last2, _Compare __comp) {
    __DST_REQUIRES(_InputIter1, _InputIterator);
    __DST_REQUIRES(_InputIter2, _InputIterator);
    __DST_REQUIRES_SAME_TYPE(typename iterator_traits<_InputIter1>::value_type,
                             typename iterator_traits<_InputIter2>::value_type);
...
_InputIter find_first_of(_InputIter __first1, _InputIter __last1,
    ...
    __DST_REQUIRES(_ForwardIter, _ForwardIterator);
    __DST_REQUIRES_BINARY_OP(
        _OP_EQUAL, bool, typename iterator_traits<_InputIter>::value_type,
        typename iterator_traits<_ForwardIter>::value_type);
...
__find_end(_BidirectionalIter1 __first1, _BidirectionalIter1 __last1,
    ...
    _RevIter1 __rresult =
        search(_RevIter1(__last1), __rlast1, _RevIter2(__last2), __rlast2);
...
__find_end(_BidirectionalIter1 __first1, _BidirectionalIter1 __last1,
    ...
    _RevIter1 __rresult = search(_RevIter1(__last1), __rlast1,
                                 _RevIter2(__last2), __rlast2, __comp);
...
template <class _ForwardIter1, class _ForwardIter2>
inline _ForwardIter1 find_end(_ForwardIter1 __first1, _ForwardIter1 __last1,
                              _ForwardIter2 __first2, _ForwardIter2 __last2) {
    __DST_REQUIRES(_ForwardIter1, _ForwardIterator);
    __DST_REQUIRES(_ForwardIter2, _ForwardIterator);
    __DST_REQUIRES_BINARY_OP(
...
inline _ForwardIter1 find_end(_ForwardIter1 __first1, _ForwardIter1 __last1,
    ...
    return __find_end(__first1, __last1, __first2, __last2,
                      __ITERATOR_CATEGORY(__first1),
                      __ITERATOR_CATEGORY(__first2), __comp);
}
...
inline bool is_heap(_RandomAccessIter __first, _RandomAccessIter __last) {
    __DST_REQUIRES(_RandomAccessIter, _RandomAccessIterator);
    __DST_REQUIRES(typename iterator_traits<_RandomAccessIter>::value_type,
                   _LessThanComparable);
