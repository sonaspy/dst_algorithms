...
#if defined(__macos) && !defined(__GNUC__)
#include <standards.h>
#if !defined(_BOOL)
...
#endif
#if _COMPILER_VERSION >= 730 && defined(_STANDARD_C_PLUS_PLUS)
#define __SGI_DST_USE_AUTO_PTR_CONVERSIONS
#endif
#endif
...
#define __DST_PTHREADS
#endif
#define __SGI_DST_NO_ARROW_OPERATOR
#define __DST_PARTIAL_SPECIALIZATION_SYNTAX
#define __DST_NO_EXCEPTION_HEADER
#define __DST_NO_BAD_ALLOC
#endif
...
// features.  __DST_USE_SGI_ALLOCATORS is a hook so that users can
...
// allocators as before, without having to edit library headers.
    ...
    !defined(__DST_USE_SGI_ALLOCATORS)
...
#if defined(__DST_WIN32THREADS) || defined(__DST_SGI_THREADS) || defined(__DST_PTHREADS) || defined(__DST_UITHREADS)
