...
#ifndef __DST_USE_CONCEPT_CHECKS
...
#define __DST_REQUIRES(__type_var, __concept)                                  \
    do {                                                                       \
    } while (0)
#define __DST_CLASS_REQUIRES(__type_var, __concept)                            \
    static int __##__type_var##_##__concept
#define __DST_CONVERTIBLE(__type_x, __type_y)                                  \
    do {                                                                       \
    } while (0)
#define __DST_REQUIRES_SAME_TYPE(__type_x, __type_y)                           \
    do {                                                                       \
    } while (0)
#define __DST_CLASS_REQUIRES_SAME_TYPE(__type_x, __type_y)                     \
    static int __##__type_x##__type_y##_require_same_type
#define __DST_GENERATOR_CHECK(__func, __ret)                                   \
    do {                                                                       \
    } while (0)
#define __DST_CLASS_GENERATOR_CHECK(__func, __ret)                             \
    static int __##__func##__ret##_generator_check
#define __DST_UNARY_FUNCTION_CHECK(__func, __ret, __arg)                       \
    do {                                                                       \
    } while (0)
...
#define __DST_CONVERTIBLE(__type_x, __type_y)                                  \
    do {                                                                       \
        void (*__x)(__type_x, __type_y) = _DST_CONVERT_ERROR<                  \
            __type_x, __type_y>::__type_X_is_not_convertible_to_type_Y;        \
        __x = __x;                                                             \
    } while (0)
...
#define __DST_REQUIRES_SAME_TYPE(__type_x, __type_y)                           \
    do {                                                                       \
        void (*__x)(__type_x, __type_y) =                                      \
            _DST_SAME_TYPE_ERROR<__type_x,                                     \
...
#define __DST_GENERATOR_CHECK(__func, __ret)                                   \
    do {                                                                       \
        __ret (*__x)(__func &) =                                               \
            _DST_GENERATOR_ERROR<__func,                                       \
                                 __ret>::__generator_requirement_violation;    \
        __x = __x;                                                             \
    } while (0)

#define __DST_UNARY_FUNCTION_CHECK(__func, __ret, __arg)                       \
    do {                                                                       \
        __ret (*__x)(__func &, const __arg &) = _DST_UNARY_FUNCTION_ERROR<     \
...
#ifdef __DST_NO_FUNCTION_PTR_IN_CLASS_TEMPLATE
...
#define __DST_CLASS_REQUIRES_SAME_TYPE(__type_x, __type_y)                     \
    ...
    static __dummy_struct_##__type_x##__type_y##_same_type<                    \
        _DST_SAME_TYPE_ERROR<__type_x, __type_y>::__type_X_not_same_as_type_Y> \
...
#define __DST_CLASS_GENERATOR_CHECK(__func, __ret)                             \
    ...
    static __dummy_struct_##__func##__ret##_generator<_DST_GENERATOR_ERROR<    \
...
#define __DST_CLASS_UNARY_FUNCTION_CHECK(__func, __ret, __arg)                 \
    ...
    static __dummy_struct_##__func##__ret##__arg##_unary_check<                \
        _DST_UNARY_FUNCTION_ERROR<                                             \
            __func, __ret, __arg>::__unary_function_requirement_violation>     \
        __dummy_ptr_##__func##__ret##__arg##_unary_check

#define __DST_CLASS_BINARY_FUNCTION_CHECK(__func, __ret, _first, __second)     \
    typedef __ret (*__f_##__func##__ret##_first##__second##_binary_check)(     \
        __func &, const _first &, const __second &);                           \
...
#define __DST_CLASS_REQUIRES_BINARY_OP(__opname, __ret, _first, __second)      \
    typedef __ret (*__f_##__func##__ret##_first##__second##_binary_op)(        \
        const _first &, const __second &);                                     \
...
struct _DST_UNARY_FUNCTION_ERROR {
    static _Ret __unary_function_requirement_violation(_Func &__f,
                                                       const _Arg &__arg) {
        return __f(__arg);
    }
};
...
struct _DST_UNARY_FUNCTION_ERROR<_Func, void, _Arg> {
    static void __unary_function_requirement_violation(_Func &__f,
                                                       const _Arg &__arg) {
        __f(__arg);
    }
};
...
struct _DST_BINARY_FUNCTION_ERROR {
    static _Ret
    __binary_function_requirement_violation(_Func &__f, const _First &_first,
...
#define __DST_DEFINE_BINARY_OP_CHECK(_OP, _NAME)                               \
    template <class _Ret, class _First, class _Second>                         \
    struct _DST_BINARY##_NAME##_ERROR {                                        \
        static _Ret __const_binary_operator_requirement_violation(             \
            const _First &_first, const _Second &__second) {                   \
...
__DST_DEFINE_BINARY_OP_CHECK(==, _OP_EQUAL);
__DST_DEFINE_BINARY_OP_CHECK(!=, _OP_NOT_EQUAL);
__DST_DEFINE_BINARY_OP_CHECK(<, _OP_LESS_THAN);
__DST_DEFINE_BINARY_OP_CHECK(<=, _OP_LESS_EQUAL);
__DST_DEFINE_BINARY_OP_CHECK(>, _OP_GREATER_THAN);
__DST_DEFINE_BINARY_OP_CHECK(>=, _OP_GREATER_EQUAL);
__DST_DEFINE_BINARY_OP_CHECK(+, _OP_PLUS);
__DST_DEFINE_BINARY_OP_CHECK(*, _OP_TIMES);
__DST_DEFINE_BINARY_OP_CHECK(/, _OP_DIVIDE);
__DST_DEFINE_BINARY_OP_CHECK(-, _OP_SUBTRACT);
__DST_DEFINE_BINARY_OP_CHECK(%, _OP_MOD);
// ...
...
struct _DST_ERROR {
    ...
    template <class _Type>
    static _Type __default_constructor_requirement_violation(_Type) {
        return _Type();
    }
    template <class _Type>
    static _Type __assignment_operator_requirement_violation(_Type __a) {
        __a = __a;
        return __a;
    }
    template <class _Type>
    static _Type __copy_constructor_requirement_violation(_Type __a) {
        _Type __c(__a);
        return __c;
    }
    template <class _Type>
    ...
    template <class _Type>
    static _Type __less_than_comparable_requirement_violation(_Type __a,
                                                              _Type __b) {
    ...
    template <class _Type>
    static _Type __equality_comparable_requirement_violation(_Type __a,
                                                             _Type __b) {
        if (__a == __b || __a != __b)
            return __a;
        return __b;
    ...
    static void __dereference_operator_requirement_violation(_Iterator __i) {
    ...
    template <class _Iterator>
    static void __preincrement_operator_requirement_violation(_Iterator __i) {
        ++__i;
    }
    template <class _Iterator>
    static void __postincrement_operator_requirement_violation(_Iterator __i) {
        __i++;
    }
    template <class _Iterator>
    static void __predecrement_operator_requirement_violation(_Iterator __i) {
        --__i;
    }
    template <class _Iterator>
    static void __postdecrement_operator_requirement_violation(_Iterator __i) {
        __i--;
    }
    ...
    template <class _Iterator, class _Distance>
    static _Iterator __iterator_addition_requirement_violation(_Iterator __i,
                                                               _Distance __n) {
        __i = __i + __n;
        __i = __n + __i;
        return __i;
    ...
    template <class _Exp, class _Type, class _Distance>
    static void
    __element_assignment_operator_requirement_violation(_Exp __x, _Type *__t,
                                                        _Distance __n) {
        __x[__n] = *__t;
    }
...
struct _Assignable_concept_specification {
    static void _Assignable_requirement_violation(_Type __a) {
        ...
        _DST_ERROR::__const_parameter_required_for_copy_constructor(__a, __a);
        _DST_ERROR::__const_parameter_required_for_assignment_operator(__a,
                                                                       __a);
    }
};
...
struct _TrivialIterator_concept_specification {
    static void _TrivialIterator_requirement_violation(_TrivialIterator __i) {
        typedef typename __value_type_type_definition_requirement_violation<
            _TrivialIterator>::value_type __T;
        // Refinement of Assignable
        _Assignable_concept_specification<
            _TrivialIterator>::_Assignable_requirement_violation(__i);
        // Refinement of DefaultConstructible
        _DefaultConstructible_concept_specification<
            _TrivialIterator>::_DefaultConstructible_requirement_violation(__i);
        // Refinement of EqualityComparable
        _EqualityComparable_concept_specification<
            _TrivialIterator>::_EqualityComparable_requirement_violation(__i);
        // Valid Expressions
        _DST_ERROR::__dereference_operator_requirement_violation(__i);
    }
};
...
struct _Mutable_TrivialIterator_concept_specification {
    ...
    _Mutable_TrivialIterator_requirement_violation(_TrivialIterator __i) {
        _TrivialIterator_concept_specification<
            _TrivialIterator>::_TrivialIterator_requirement_violation(__i);
        // Valid Expressions
        _DST_ERROR::__dereference_operator_and_assignment_requirement_violation(
            __i);
    }
};
...
struct _InputIterator_concept_specification {
    static void _InputIterator_requirement_violation(_InputIterator __i) {
        ...
        _TrivialIterator_concept_specification<
            _InputIterator>::_TrivialIterator_requirement_violation(__i);
        // Associated Types
        ...
        __iterator_category_type_definition_requirement_violation<
            _InputIterator>();
        // Valid Expressions
        _DST_ERROR::__preincrement_operator_requirement_violation(__i);
        _DST_ERROR::__postincrement_operator_requirement_violation(__i);
    }
};
...
struct _OutputIterator_concept_specification {
    static void _OutputIterator_requirement_violation(_OutputIterator __i) {
        // Refinement of Assignable
        _Assignable_concept_specification<
            _OutputIterator>::_Assignable_requirement_violation(__i);
        // Associated Types
        __iterator_category_type_definition_requirement_violation<
            _OutputIterator>();
        // Valid Expressions
...
struct _ForwardIterator_concept_specification {
    static void _ForwardIterator_requirement_violation(_ForwardIterator __i) {
        ...
        _InputIterator_concept_specification<
            _ForwardIterator>::_InputIterator_requirement_violation(__i);
    }
};
...
struct _Mutable_ForwardIterator_concept_specification {
    ...
    _Mutable_ForwardIterator_requirement_violation(_ForwardIterator __i) {
        _ForwardIterator_concept_specification<
            _ForwardIterator>::_ForwardIterator_requirement_violation(__i);
        // Refinement of OutputIterator
        _OutputIterator_concept_specification<
            _ForwardIterator>::_OutputIterator_requirement_violation(__i);
    }
};
...
struct _BidirectionalIterator_concept_specification {
    ...
    _BidirectionalIterator_requirement_violation(_BidirectionalIterator __i) {
        ...
        // Valid Expressions
        _DST_ERROR::__predecrement_operator_requirement_violation(__i);
        _DST_ERROR::__postdecrement_operator_requirement_violation(__i);
    }
};

template <class _BidirectionalIterator>
struct _Mutable_BidirectionalIterator_concept_specification {
    static void _Mutable_BidirectionalIterator_requirement_violation(
        ...
        // Valid Expressions
        _DST_ERROR::
            __postincrement_operator_and_assignment_requirement_violation(
                __i, *__tmp_ptr);
    }
};
...
struct _RandomAccessIterator_concept_specification {
    static void _RandomAccessIterator_requirement_violation(_RandAccIter __i) {
        // Refinement of BidirectionalIterator
        _BidirectionalIterator_concept_specification<
            _RandAccIter>::_BidirectionalIterator_requirement_violation(__i);
        // Refinement of LessThanComparable
        _LessThanComparable_concept_specification<
            _RandAccIter>::_LessThanComparable_requirement_violation(__i);
        typedef typename __value_type_type_definition_requirement_violation<
            _RandAccIter>::value_type value_type;
        typedef
            typename __difference_type_type_definition_requirement_violation<
                _RandAccIter>::difference_type _Dist;
        typedef typename _Mutable_trait<_Dist>::_Type _MutDist;

        // Valid Expressions
        _DST_ERROR::__iterator_addition_assignment_requirement_violation(
            __i, _MutDist());
        _DST_ERROR::__iterator_addition_requirement_violation(__i, _MutDist());
        _DST_ERROR::__iterator_subtraction_assignment_requirement_violation(
            __i, _MutDist());
        _DST_ERROR::__iterator_subtraction_requirement_violation(__i,
                                                                 _MutDist());
        _DST_ERROR::__difference_operator_requirement_violation(__i, __i,
                                                                _MutDist());
        typename _Mutable_trait<value_type>::_Type *__dummy_ptr = 0;
        _DST_ERROR::__element_access_operator_requirement_violation(
            __i, __dummy_ptr, _MutDist());
    }
};
...
struct _Mutable_RandomAccessIterator_concept_specification {
    ...
    _Mutable_RandomAccessIterator_requirement_violation(_RandAccIter __i) {
        _RandomAccessIterator_concept_specification<
            _RandAccIter>::_RandomAccessIterator_requirement_violation(__i);
        ...
        // Valid Expressions
        _DST_ERROR::__element_assignment_operator_requirement_violation(
            __i, __tmp_ptr, _Dist());
    }
};

#define __DST_TYPEDEF_REQUIREMENT(__REQUIREMENT)                               \
    template <class Type>                                                      \
    struct __##__REQUIREMENT##__typedef_requirement_violation {                \
        typedef typename Type::__REQUIREMENT __REQUIREMENT;                    \
    }

__DST_TYPEDEF_REQUIREMENT(value_type);
__DST_TYPEDEF_REQUIREMENT(difference_type);
__DST_TYPEDEF_REQUIREMENT(size_type);
__DST_TYPEDEF_REQUIREMENT(reference);
__DST_TYPEDEF_REQUIREMENT(const_reference);
...
struct _Allocator_concept_specification {
    static void _Allocator_requirement_violation(_Alloc __a) {
        // Refinement of DefaultConstructible
        _DefaultConstructible_concept_specification<
            _Alloc>::_DefaultConstructible_requirement_violation(__a);
        // Refinement of EqualityComparable
        _EqualityComparable_concept_specification<
            _Alloc>::_EqualityComparable_requirement_violation(__a);
        // Associated Types
        ...
        //__DST_REQUIRES_SAME_TYPE(typename _Alloc::__DST_TEMPLATE
        // rebind<_Tp>::other,
        //                         _Alloc);
    }
};

#endif /* __DST_USE_CONCEPT_CHECKS */
