#ifndef ___DST_INTERNAL_MULTISET_H
#define ___DST_INTERNAL_MULTISET_H
...
template <class _Key, class _Compare __DST_DEPENDENT_DEFAULT_TMPL(less<_Key>),
          class _Alloc = __DST_DEFAULT_ALLOCATOR(_Key)>
class multiset;
...
class multiset {
    ...
    __DST_CLASS_BINARY_FUNCTION_CHECK(_Compare, bool, _Key, _Key);
  ...
  public:
    ...
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const multiset &, const multiset &);
    friend bool __VDSA_QUALIFIER operator<
        __DST_NULL_TMPL_ARGS(const multiset &, const multiset &);
...
#endif /* ___DST_INTERNAL_MULTISET_H */
