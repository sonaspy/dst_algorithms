...
__DST_TYPEDEF_REQUIREMENT(iterator);
__DST_TYPEDEF_REQUIREMENT(const_iterator);
...
template <class _Container> struct _Container_concept_specification {
    static void _Container_requirement_violation(_Container __c) {
        ...
        _ERROR_IN_DST_CONTAINER::__swap_function_requirement_violation(__c);
...
__DST_TYPEDEF_REQUIREMENT(reverse_iterator);
...
#endif /* __DST_CONTAINER_CONCEPTS_H */
