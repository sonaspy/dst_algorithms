#ifndef ___DST_INTERNAL_MULTIMAP_H
#define ___DST_INTERNAL_MULTIMAP_H
...
template <class _Key, class _Tp,
          class _Compare __DST_DEPENDENT_DEFAULT_TMPL(less<_Key>),
...
class multimap {
  ...
  public:
    ...
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const multimap &, const multimap &);
    friend bool __VDSA_QUALIFIER operator<
        __DST_NULL_TMPL_ARGS(const multimap &, const multimap &);
...
#endif /* ___DST_INTERNAL_MULTIMAP_H */
