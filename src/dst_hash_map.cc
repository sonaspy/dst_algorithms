#ifndef ___DST_INTERNAL_HASH_MAP_H
#define ___DST_INTERNAL_HASH_MAP_H
...
template <class _Key, class _Tp,
          class _HashFcn __DST_DEPENDENT_DEFAULT_TMPL(hash<_Key>),
          class _EqualKey __DST_DEPENDENT_DEFAULT_TMPL(equal_to<_Key>),
          class _Alloc = __DST_DEFAULT_ALLOCATOR(_Tp)>
class hash_map;
...
class hash_map {
    ...
    __DST_CLASS_REQUIRES(_Key, _Assignable);
    __DST_CLASS_REQUIRES(_Tp, _Assignable);
    __DST_CLASS_UNARY_FUNCTION_CHECK(_HashFcn, size_t, _Key);
    __DST_CLASS_BINARY_FUNCTION_CHECK(_EqualKey, bool, _Key, _Key);
  ...
  public:
    ...
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const hash_map &, const hash_map &);
#endif /* __DST_MEMBER_TEMPLATES */
...
#else  /* __DST_MEMBER_TEMPLATES */
    friend bool __VDSA_QUALIFIER operator==
        __DST_NULL_TMPL_ARGS(const hash_multimap &, const hash_multimap &);
#endif /* __DST_MEMBER_TEMPLATES */
...
#endif /* ___DST_INTERNAL_HASH_MAP_H */
