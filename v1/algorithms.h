...
template <class _RandomAccessIterator>
void __unique_merge(_RandomAccessIterator _first1, _RandomAccessIterator _last1,
                    _RandomAccessIterator _first2, _RandomAccessIterator _last2,
                    _RandomAccessIterator _res) {
...
template <class _RandomAccessIterator>
bool array_move(_RandomAccessIterator _first, _RandomAccessIterator _last,
                int _offset, bool _left = true) {
    if (_first < _last) {
...
template <class _RandomAccessIterator, class _Tp = typename iterator_traits<
                                           _RandomAccessIterator>::value_type>
_Tp median_search(_RandomAccessIterator _first1, _RandomAccessIterator _last1,
                  _RandomAccessIterator _first2, _RandomAccessIterator _last2) {
...
static inline void __siftdown(_RandomAccessIterator _base, int _pos,
                              int _border, _Compare _comp) {
    int _up = _pos, _down = _pos * 2 + 1;
    for (; _down < _border; _up = _down, _down = _down * 2 + 1) {
        if (_down + 1 < _border &&
            _comp(*(_base + _down), *(_base + _down + 1)))
            _down++;
...
template <typename _RandomAccessIterator, typename _Compare>
static inline void __makeheap(_RandomAccessIterator _first,
...
template <typename _RandomAccessIterator, typename _Compare>
static inline void __pushheap(_RandomAccessIterator _first,
                              _RandomAccessIterator _last, _Compare _comp) {
...
template <typename _RandomAccessIterator, typename _Compare>
static inline void __popheap(_RandomAccessIterator _first,
                             _RandomAccessIterator _last, _Compare _comp) {
...
static inline bool __isheap(_RandomAccessIterator _first,
    ...
    for (; 0 <= _pos; --_pos)
        if (_comp(*(_first + _pos), *(_first + _pos * 2 + 1)) ||
            _comp(*(_first + _pos), *(_first + _pos * 2 + 2)))
            return false;
    return true;
}

template <class _RandomAccessIterator>
static inline void makeheap(_RandomAccessIterator _first,
...
template <class _RandomAccessIterator>
static inline void pushheap(_RandomAccessIterator _first,
                            _RandomAccessIterator _last) {
    __pushheap(
        _first, _last,
        less<typename iterator_traits<_RandomAccessIterator>::value_type>());
...
template <class _RandomAccessIterator>
static inline void popheap(_RandomAccessIterator _first,
                           _RandomAccessIterator _last) {
    __popheap(
        _first, _last,
        less<typename iterator_traits<_RandomAccessIterator>::value_type>());
...
template <class _RandomAccessIterator>
static inline bool isheap(_RandomAccessIterator _first,
                          _RandomAccessIterator _last) {
    return __isheap(
        _first, _last,
        less<typename iterator_traits<_RandomAccessIterator>::value_type>());
...
template <class _RandomAccessIterator, typename _Compare>
static inline void isheap(_RandomAccessIterator _first,
                          _RandomAccessIterator _last, _Compare _comp) {
...
_RandomAccessIterator __lower_bound(_RandomAccessIterator _first,
                                    _RandomAccessIterator _last,
                                    const _Tp &_val) {
...
template <typename _Tp, typename _RandomAccessIterator>
_RandomAccessIterator __upper_bound(_RandomAccessIterator _first,
                                    _RandomAccessIterator _last,
                                    const _Tp &_val) {
    int _length = _last - _first, _half_len;
    _RandomAccessIterator _mid;
...
_RandomAccessIterator bin_search(_RandomAccessIterator _first,
                                 _RandomAccessIterator _last, const _Tp &_val) {
    _RandomAccessIterator _mid;
    while (_first <= _last) {
...
// vector use , push_back rear _val, then __linear_insert(a.begin(), a.end()-1,
// a.back());
