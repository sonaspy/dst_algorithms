                        ...
                        for (int i = eNode.sizeOfPartialTour + 1; i < n; i++)
                            if (a[partialTour[eNode.sizeOfPartialTour]]
                                    [partialTour[i]] != noEdge)
                                {
                                    ...
                                    T costOfPartialTour = eNode.costOfPartialTour + a[partialTour[eNode.sizeOfPartialTour]]
                                                          [partialTour[i]];
                                    T minAdditionalCost = eNode.minAdditionalCost - costOfMinOutEdge[partialTour
                                                          [eNode.sizeOfPartialTour]];
                                    T leastCostPossible = costOfPartialTour + minAdditionalCost;
        ...
        if (currentLevel == n)
        ...
        else
            {
                ...
                for (int j = currentLevel; j <= n; j++)
                    ...
                    if (a[partialTour[currentLevel - 1]][partialTour[j]] != noEdge && (costOfBestTourSoFar == noEdge ||
                            costOfPartialTour +
